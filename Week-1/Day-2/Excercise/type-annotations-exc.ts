...
const titles:string[] = [
  ...
  const linkAuthors = (authors:string[], titles:string[], ignoreMissingTitles:boolean):any => {
  ...
  const myfunction: MyFunction = (firstName:string, lastName:string):number => {
